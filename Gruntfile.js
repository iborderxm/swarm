...
module.exports = function (grunt) {
  ...
  grunt.registerMultiTask('preloadSpreadsheet', 'Update spreadsheet data', function () {
    // https://docs.google.com/spreadsheets/d/1ughCy983eK-SPIcDYPsjOitVZzY10WdI2MGGrmxzxF4/edit#gid=0
    // https://developers.google.com/sheets/api/guides/migration#v4-api_4
    // https://www.npmjs.com/package/tabletop
    // archived files are in `/app/scripts/spreadsheetpreload`
    console.log('google killed the apis, hooray. TODO: figure out a new way to update the spreadsheet data, and/or move it away from google')
  });
